...
def evaluate(
    ...
    "avg_return_mean": np.mean(total_returns),
    "avg_return_std": np.std(total_returns),

    "avg_length": np.mean(total_lengths),
    "avg_length_mean": np.mean(total_lengths),
    "avg_length_std": np.std(total_lengths),

    "avg_success": np.mean(total_successes),
    "avg_success_mean": np.mean(total_successes),
    "avg_success_std": np.std(total_successes),
    }
